<template>
    <div class="blueBackground">
        ...
        <div class="centeredGrid">
            ...
            <div id="pets">
                <div class="dogItemContainer" v-for="(dog, index) in dogs" v-bind:id="'dog' + index" :key="index" @click="goToBooking('dog', dog.name)">
                </div>
                <div class="dogItemContainer" v-for="(cat, index) in cats" v-bind:id="'cat' + index" :key="index" @click="goToBooking('cat', cat.name)">
                </div>
            </div>
        </div>
    </div>
